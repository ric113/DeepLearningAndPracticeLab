...
def eval_split(model, crit, loader, eval_kwargs={}):
    ...
    while True:
        ...
        for k, sent in enumerate(sents):
            ...
            attentionVisualization(data['infos'][k]['file_path'], sent, temp, entry['image_id'])
...
def attentionVisualization(image_name, caption, alphas, id):
    ...
    for t in range(len(words)):
        ...
        plt.axis('off')
    plt.savefig(str(id) + 'test_att.png')
    plt.clf()